...
#Este código es el que está funcionando
...
#esta config sirve pero no con la webcam
pid_x = PID(0.5, 0.05, 0)
pid_y = PID(0.5, 0.05, 0)

""" pid_x = PID(0.3, 0.02, 0.09)
pid_y = PID(0.3, 0.02, 0.09) """
...
tracking = False
first_face = None
check_interval = 5  # Segundos entre cada verificación de rostro
...
while True:
    ...
    if current_time - time_since_last_detection > check_interval:
